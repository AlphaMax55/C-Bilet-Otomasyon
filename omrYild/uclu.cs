...
namespace omrYild
{
    public partial class uclu : Form
    {
        ...
        private void uclukoltuk_Load(object sender, EventArgs e)
        {
            yolcudoldur();
            bilgidoldur();
            koltuklar();
        ...
        private void bilgiler()
        {
            ...
            while (kredik.Read())
            {
                ...
                {
                    lblKrediKarti.Text = nakitt.ToString();
                }
                if (lblNakit.Text.Equals(""))
                {
                    lblNakit.Text = nakitt.ToString();
                }
        ...
        private void yolculargrid_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            bltguncel.txtSeferSayi.Text = txtSeferSayi.Text.ToString();
            bltguncel.Show();
            Hide();
        }
    }
